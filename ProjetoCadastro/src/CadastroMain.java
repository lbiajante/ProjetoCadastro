...
public class CadastroMain {
	...
	private String textInput(String label) { //método para inserções de textos e retornos de teclado
		System.out.println(label);
		return entrada.nextLine();
	}	
	public int verificaIdade(){ //método para evitar inserções de idades indesejadas
		int idade2 = 0;
